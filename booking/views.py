...
# https://www.geeksforgeeks.org/createview-class-based-views-django/?ref=lbp
class MakeBooking(generic.CreateView, LoginRequiredMixin):
    ...
    def form_valid(self, form):
        # code altered from
        # https://stackoverflow.com/questions/70671189/avoid-booking-past-dates-with-django
...
class BookingDetails(generic.ListView, LoginRequiredMixin):
    ...
    def get_queryset(self):
        return Booking.objects.filter(
            customer=self.request.user).order_by('day', 'time')
